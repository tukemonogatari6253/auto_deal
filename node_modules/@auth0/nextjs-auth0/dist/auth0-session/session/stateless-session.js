...
var StatelessSession = /** @class */ (function (_super) {
    ...
    StatelessSession.prototype.setSession = function (req, res, session, uat, iat, exp, cookieOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var sessionName, cookieSetter, cookies, value, chunkCount, existingCookies, i, chunkValue, chunkCookieName;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        existingCookies = new Set(Object.keys(cookies).filter(function (cookie) { return cookie.match("^".concat(sessionName, "(?:\\.\\d)?$")); }));
                        if (chunkCount > 1) {
                        ...
                        existingCookies.forEach(function (cookie) { return cookieSetter.clear(cookie, cookieOptions); });
